<?
    ...
    $st_id = $_GET['st_id'];
    $sql="select * from memberlist where st_id = '$st_id'";
...
<body>
    ...
    <input type=hidden name="g_id" value="<? echo $g_id; ?>">
        <table class="table table-hover">
            <p align=center style="font-size: 28px;"><b>修改專題組員</b></p>
            <thead>
                <td width=45%></td>
                <td width=55%></td>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="st_id" value="<? echo $st_id; ?>" readonly></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="st_dep" id="dep-list" value="<? echo $st_dep; ?>" required></select></td>
                </tr>
                <tr>
                    <td  align=right><b>姓名：</b></td>
                    <td><input type="text" name="st_name" value="<? echo $st_name; ?>" required></td>
                </tr>
            </tbody>
            <tfoot>
...
var colleges = ['預設','藝術學院', '文學院', '醫學院', '外國語文學院', '民生學院', 
...
st_dep[0]=["<?echo $st_dep;?>"]
st_dep[1]=["音樂學系", "應用美術學系", "景觀設計學系"];
st_dep[2]=["中國文學系", "歷史學系", "哲學系"];
st_dep[3]=["護理學系", "公共衛生學系", "醫學系", "臨床心理學系", "職能治療學系", "呼吸治療學系"];
st_dep[4]=["英國語文學系", "法國語文學系", "西班牙語文學系", "日本語文學系" , "義大利語文學系" , "德語語文學系"];
st_dep[5]=["餐旅管理學系", "兒童與家庭學系", "食品科學系", "營養科學系"];
st_dep[6]=["影像傳播學系", "新聞傳播學系", "廣告傳播學系"];
st_dep[7]=["法律學系", "財經法律學系", "學士後法律學系"];
st_dep[8]=["圖書資訊學系", "體育學系體育學組" , "體育學系運動競技組", "體育學系運動健康管理組"];
st_dep[9]=["企業管理學系", "金融與國際企業學系", "會計學系", "資訊管理學系", "統計資訊學系"];
st_dep[10]=["數學系純數學組", "數學系應用數學組", "化學系", "資訊工程學系", "生命科學系", "物理學系物理組", "物理學系光電物理組", "電機工程學系"];
st_dep[11]=["心理學系", "社會學系", "社會工作學系", "經濟學系", "宗教學系"];
st_dep[12]=["織品服裝學系織品設計組", "織品服裝學系織品服飾行銷組", "織品服裝學系服飾設計組"];
